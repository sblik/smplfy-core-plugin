...
abstract class SMP_BaseEntity {
	 ...
	 * In the context of the BS_BaseEntity class, the __get method is used to retrieve the value of a property from the formEntry array.
	 *
	 * @param $property
	 *
	 * @return mixed|null
	 ...
	 * In the context of the BS_BaseEntity class, the __set method is used to set the value of a property in the formEntry array.
	 *
	 * @param $property
	 * @param $value
	 *
